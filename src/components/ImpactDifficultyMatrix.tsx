...
export const ImpactDifficultyMatrix: React.FC<ImpactDifficultyMatrixProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-[calc(100vh-8rem)]">
      <div className="mb-6 w-full text-left flex justify-between items-end">
        <div>
      ...
      <div className="flex-1 flex gap-6 min-h-0">
        ...
        <div className="flex-1 relative flex flex-col">
          ...
          <div className="flex-1 border-l-2 border-b-2 border-gray-800 relative ml-4 mb-4 bg-gray-50/50">
            ...
            {data.opportunities.map((opp) => {
              ...
              const offset = siblings.length > 1 ? (index - (siblings.length - 1) / 2) * 8 : 0;
              ...
              return (
                <button
                  ...
                  className={`absolute w-4 h-4 -ml-2 -mb-2 rounded-full border-2 transition-all transform hover:scale-150 hover:z-10 ${
